...
st.write("This app uses 6 inputs to predict the species of penguin using"
 "a model built on the Palmer Penguins dataset. Use the form \
...
bill_length = st.number_input("Bill Length (mm)", value=0.0, min_value=0.0, step=0.1, format="%.2f")
bill_depth = st.number_input("Bill Depth (mm)", value=0.0, min_value=0.0, step=0.1, format="%.2f")
